...
Can we make a similar statement?

Consider any $\mathbf{u} \in V$.
...
$$
\mathbf{w}_{\parallel}=\sum_{i=1}^k \frac{\langle \mathbf{u},\mathbf{e}_i \rangle}{\langle \mathbf{e}_i,\mathbf{e}_i \rangle }\mathbf{e}_i
$$
This is our candidate projection. So we construct the vector orthogonal to $W$
$$
\mathbf{u}-\mathbf{w}_{\parallel}=\mathbf{u}-\sum_{i=1}^k \frac{\langle \mathbf{u},\mathbf{e}_i \rangle}{\langle \mathbf{e}_i,\mathbf{e}_i \rangle }\mathbf{e}_i
$$  
